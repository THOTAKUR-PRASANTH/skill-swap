...
const CustomSignUpPage = () => {
  ...
  return (
    <>
      {/* --- NO CHANGE --- Style block is correct --- */}
      <style jsx global>{`
      ...
      {/* --- CHANGED --- Added 'overflow-x-hidden' --- */}
      <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden p-4 flex items-start md:items-center justify-center min-h-screen bg-black/50">
        <motion.div
          className="my-auto" 
