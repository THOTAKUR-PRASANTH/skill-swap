...
// import { FirebaseClientInitializer } from "@/components/firebaseclient/FirebaseClientInitializer";
...
import { Session } from "next-auth";
import dynamic from "next/dynamic";
import { useEffect } from "react"; // <-- Already imported, good.
import { useLoader } from "@/app/context/LoaderContext";
import { FirebaseClientInitializer } from "@/components/firebaseclient/FirebaseClientInitializer";
...
export function ClientLayout({ children, session }: Props) {
  ...
  // --- This is your existing loader logic (Keep it) ---
  useEffect(() => {
    // If already finished, skip running again
    if (isInitialLoadFinished) return;
